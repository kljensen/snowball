...
// such non-vowel. R2 is not used in Danish
//
// See http://snowball.tartarus.org/texts/r1r2.html
//
func r1(word *snowballword.SnowballWord) (r1start int) {
	// Like the German R1, the length of the Danish R1 is adjusted to be at least three.
...
// Checks if a rune is a lowercase Danish vowel.
//
...
// Return `true` if the input `word` is a Danish stop word.
//
